    ...
    <>
      <section className="py-12 md:py-24 px-4 md:px-8 bg-[#F2F2F2] font-sans text-zinc-900 relative">
        <div className="max-w-[1400px] mx-auto">
          ...
          {/* --- Grid Layout --- */}
          {/* Improvement: Added md:grid-cols-2 to bridge the gap between mobile and large screens */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {events.map((event, idx) => {
              ...
              return (
                ...
                >
                  {/* Date & Category Header - Reduced padding on mobile */}
      ...
      {selectedEvent && (
        ...
        >
          {/* 
             Responsive Modal Shape:
             - Mobile: Bottom Sheet (rounded-t-3xl, h-[85vh])
             - Desktop: Center Modal (rounded-[2.5rem], max-h-[90vh])
          */}
          <div
